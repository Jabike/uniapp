  ...
  setup(__props) {
    ...
    common_vendor.onLoad((opt) => {
      api_api.detailProject().then((res) => {
        ...
        common_vendor.index.__f__("log", "at pages/detail/detail.vue:64", projectList.value);
      });
      common_vendor.index.__f__("log", "at pages/detail/detail.vue:66", JSON.parse(decodeURIComponent(opt.item)));
