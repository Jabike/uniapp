  ...
  setup(__props) {
    ...
    common_vendor.onLoad(() => {
      api_api.getBanner().then((res) => {
        common_vendor.index.__f__("log", "at pages/index/index.vue:76", res, "res");
        bannerList.value = res.bannerList;
      });
      api_api.getHomeList().then((res) => {
        common_vendor.index.__f__("log", "at pages/index/index.vue:80", res, "getHomeList");
        flowList.value = res;
      });
    });
    common_vendor.onReachBottom(() => {
      common_vendor.index.__f__("log", "at pages/index/index.vue:85", "触底");
      setTimeout(() => {
        addRandomData();
      }, 1e3);
    });
